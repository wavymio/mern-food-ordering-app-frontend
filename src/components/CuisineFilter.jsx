...
const CuisineFilter = ({ onChange, selectedCuisines, isExpanded, onExpandedClick }) => {
    ...
    const handleCuisinesChange = (ev) => {
        const clickedCuisine = ev.target.value
    ...
    return (
        <>
            <div className='flex justify-between items-center px-2'>
                ...
                <div onClick={handleCuisinesReset} className="text-md font-semibold mb-2 underline cursor-pointer text-blue-500">Reset Filters</div>
            </div>
